                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-1/4 p-2 md:p-4">
                            ...
                            <div class="border rounded-md p-2 md:p-4">
                               <img class="image" data-id="{{ $name }}_{{ $image->id }}" date-file="{{ $image->filename }}" data-path="{{ asset('storage/products/') }}" data-model="{{ $modal }}" src="{{ asset('storage/products/'.$image->filename)}}" alt="">
