                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                ...
                                <form action="{{ route('user.cart.add') }}" method="post">
                                    @csrf
                                <div class="flex item-center"><span class="mr-3">数量</span>
                    ...
                    <div class="mb-4 text-center">
                        <button type="button" data-micromodal-trigger="modal-1" href='javascript;:'
                            class="bg-gray-400 text-white border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                    </div>
