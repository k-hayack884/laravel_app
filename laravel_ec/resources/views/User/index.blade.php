        ...
        <form action="{{ route('user.items.index') }}" method="get">
            <div class="lg:flex lg:justify-around">
                <div class="lg:flex lg:items-center">
                    <select name="category" class="m
                    b-2 lg:mb-0 lg:mr-2">
                    <option value="0" @if (\Request::get('category'==='0'))selected
                        
                    @endif>すべて壊すんだ!</option>
                    @foreach ( $categories as $category )
                    <optgroup label="{{ $category->name }}">
                        @foreach ($category->secondary as $secondary )
                        {{-- 型が合わないものを合わせるにはイコールが二ついるお --}}
                    ...
                    <div>
                        <div class="flex space-x-2 items-center">
                            <div><input  name="keyword" class="border border-gray-500 py-4" placeholder="キーワードを入力"></div>
                ...
                <div class="flex">
                    <div>
                        ...
                        <select name="sort" id="sort" class="mr-2">
                    ...
                    <div>
                        ...
                        <select id="pagination" name="pagination">
                            ...
                            <option value="102" @if(\Request::get('pagination')==='102' ) selected @endif>102件
                            </option>
                        </select>
                    </div>
                </div>
