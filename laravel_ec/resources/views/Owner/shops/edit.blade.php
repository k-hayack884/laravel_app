                    ...
                    <form method="post" action="{{ route('owner.shops.update',['shop'=>$shop->id])}}"
                        ...
                        <div class="m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea type="text" id="information" name="information" rows="10" required
                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                        value="{{ $shop->information}}">{{ $shop->information}}</textarea>
                                </div>
                            </div>
                            <div class="w-32">
                            ...
                            <div class="p-2 w-1/2 mx-auto flex justify-around">
                                <div class="relative">
                                    <input type="radio" checked name="is_selling" value="1"
                                        @if($shop->is_selling===1){checked} @endif>販売中
                                    <input type="radio" name="is_selling" value="0" @if($shop->is_selling===0){checked}
                                    @endif>停止中
                                </div>
                            </div>
