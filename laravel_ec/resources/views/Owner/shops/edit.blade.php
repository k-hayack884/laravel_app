                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="post" action="{{ route('owner.shops.update',['shop'=>$shop->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                        <label for="information" class="leading-7 text-sm text-gray-600">店舗情報
                                            ※必須</label>
                                        <textarea type="text" id="information" name="information" rows="10" required
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" value="{{ $shop->information}}">{{ $shop->information}}</textarea>
                                    </div>
                                </div>
                                <div class="w-32">
                                ...
                                <div class="p-2 w-1/2 mx-auto flex justify-around">
                                    <div class="relative">
                                        <input type="radio" checked name="is_selling" value="1" @if($shop->is_selling===1){checked} @endif>販売中
